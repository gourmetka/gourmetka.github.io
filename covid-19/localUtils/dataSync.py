...
missing_population_map = {
  ...
  "Heilbronn (city)": 125113,
  "Heilbronn (county)": 343068,
  "Karlsruhe (city)": 313092,
  "Karlsruhe (county)": 444232,
  "Ansbach (city)": 41847,
  "Ansbach (county)": 183949,
  "Aschaffenburg (city)": 70527,
  "Aschaffenburg (county)": 174208,
  "Augsburg (city)": 295135,
  "Augsburg (county)": 251534,
  "Bamberg (city)": 77592,
  "Bamberg (county)": 147086,
  "Bayreuth (city)": 74657,
  "Bayreuth (county)": 103656,
  "Coburg (county)": 86906,
  "Fürth (city)": 127748,
  "Fürth (county)": 117387,
  "Hof (city)": 45950,
  "Hof (county)": 95311,
  "Landshut (city)": 72404,
  "Landshut (county)": 158698,
  "München (city)": 1471508,
  "München (county)": 348871,
  "Passau (city)": 52469,
  "Passau (county)": 192043,
  "Regensburg (city)": 152610,
  "Regensburg (county)":193572,
  "Rosenheim (city)": 63324,
  "Rosenheim (county)": 260983,
  "Schweinfurt (city)": 54032,
  "Schweinfurt (county)": 115106,
  "Würzburg (city)": 127880,
  "Würzburg (county)": 161834,
  "Kassel (city)": 201585,
  "Kassel (county)": 236633,
  "Offenbach": 128744,
  "Rostock (city)": 208886,
  "Rostock (county)": 215113,
  "Oldenburg (city)": 168210,
  "Oldenburg (county)": 130144,
  "Osnabrück (city)": 164748,
  "Osnabrück (county)": 357343,
  "Kaiserslautern (city)": 99845,
  "Kaiserslautern (county)": 106057,
  "Leipzig (city)": 587857,
...
for d in data:
  if "L.marker" in d.decode("utf-8") and "Germany" in d.decode("utf-8"):
    ...
    germany_deaths = int(germany_status[1].replace("deaths", "").replace("&thinsp;", "").strip())
    break
...
for city in city_list:
  city_object = {
    "city_name": city[2],
    "infected": int(city[4].replace("&thinsp;", "").strip()),
    "geo": [city[0], city[1]],
    "state": stateofCity(region_city_map, city[2], city[0], city[1]),
    "population": getPopupation(city_data_exists_population, city[2]),
    "ratio": calc_city_infection_ratio(int(city[4].replace("&thinsp;", "").strip()), getPopupation(city_data_exists_population, city[2]))
  }
